...
developer_attributes = [
  ...
  { email: "latitia@hotmail.com", password: "12345678", first_name: "Latitia", last_name: "Schipper", phone_number: "06 78 72 18 11", city: "Amsterdam", address: "Johan Huizingalaan 763", photo: File.open(Rails.root.join("db/fixtures/images", "profile_3.jpg")), price_per_hour: 34, expertise: "front-end", availability: "parttime" },
  { email: "henk_6@hotmail.com", password: "12345678", first_name: "Henk", last_name: "de Groot", phone_number: "06 78 22 10 87", city: "Almere", address: "Stadhuisplein 1", photo: File.open(Rails.root.join("db/fixtures/images", "profile_1.jpg")), price_per_hour: 34, expertise: "front-end", availability: "parttime" },
  { email: "damian@gmail.com", password: "12345678", first_name: "Damien", last_name: "Gaanderse", phone_number: "06 18 42 60 77", city: "Rotterdam", address: "Kruiskade 63", photo: File.open(Rails.root.join("db/fixtures/images", "profile_6.jpg")), price_per_hour: 34, expertise: "back-end", availability: "fulltime" },
  { email: "annebeth@gmail.com", password: "12345678", first_name: "Annebeth", last_name: "van Velzen", phone_number: "06 18 42 21 90", city: "Utrecht", address: "Stadsplateau 1", photo: File.open(Rails.root.join("db/fixtures/images", "profile_7.jpg")), price_per_hour: 44, expertise: "full-stack", availability: "fulltime" },
  { email: "fon@gmail.com", password: "12345678", first_name: "Fon", last_name: "Fu", phone_number: "06 95 42 60 12", city: "Haarlem", address: "Gedempte oude gracht 34", photo: File.open(Rails.root.join("db/fixtures/images", "profile_8.jpg")), price_per_hour: 18, expertise: "back-end", availability: "project base" },
  { email: "don@gmail.com", password: "12345678", first_name: "Donald", last_name: "Draper", phone_number: "06 22 22 66 19", city: "Amsterdam", address: "Nassaukade 44", photo: File.open(Rails.root.join("db/fixtures/images", "profile_9.jpg")), price_per_hour: 35, expertise: "front-end", availability: "project base" },
  { email: "eunchae@gmail.com", password: "12345678", first_name: "Eun Chae", last_name: "Parker", phone_number: "06 18 88 34 71", city: "Rotterdam", address: "Kruiskade 23", photo: File.open(Rails.root.join("db/fixtures/images", "profile_10.jpg")), price_per_hour: 25, expertise: "back-end", availability: "fulltime" },
  { email: "jorrick@gmail.com", password: "12345678", first_name: "Jorrick", last_name: "de Bok", phone_number: "06 98 32 68 78", city: "Amstelveen", address: "Binnenhof 63", photo: File.open(Rails.root.join("db/fixtures/images", "profile_11.jpg")), price_per_hour: 38, expertise: "front-end", availability: "fulltime" },
  { email: "alban@gmail.com", password: "12345678", first_name: "Alban", last_name: "Benali", phone_number: "06 18 42 66 21", city: "Amsterdam", address: "Spui 11", photo: File.open(Rails.root.join("db/fixtures/images", "profile_12.jpg")), price_per_hour: 66, expertise: "full-stack", availability: "project base" },
  { email: "marcella@gmail.com", password: "12345678", first_name: "Marcella", last_name: "Dupot", phone_number: "06 18 44 60 71", city: "Utrecht", address: "Heidelberglaan 100", photo: File.open(Rails.root.join("db/fixtures/images", "profile_13a.jpg")), price_per_hour: 25, expertise: "back-end", availability: "fulltime" },
  { email: "romy@gmail.com", password: "12345678", first_name: "Romy", last_name: "van Domburg Scipio", phone_number: "06 18 42 60 77", city: "Amsterdam", address: "Amstelveenseweg 33", photo: File.open(Rails.root.join("db/fixtures/images", "profile_14.jpg")), price_per_hour: 35, expertise: "front-end", availability: "project base" }
]

client_attributes = [
  { email: "proctor_exam@gmail.com", password: "12345678", first_name: "Hans" , last_name: "Haan", company: "Proctor Exam", city: "Amsterdam", address: "johan huizingalaan 763a", photo: File.open(Rails.root.join("db/fixtures/images", "proctor_exam.jpg")) },
  { email: "wortels@gmail.com", password: "12345678", first_name: "Irene" , last_name: "Latsers", company: "Wortels", city: "Den Bosch", address: "graafseweg 60", photo: File.open(Rails.root.join("db/fixtures/images", "logo_1.jpg")) },
  ...
  { email: "linden_it@gmail.com", password: "12345678", first_name: "Gerbert Jan" , last_name: "Valk", company: "Linden IT", city: "Amsterdam", address: "johan huizingalaan 763a", photo: File.open(Rails.root.join("db/fixtures/images", "logo_10.jpg")) },
  { email: "dashmote@gmail.com", password: "12345678", first_name: "Bart" , last_name: "Graafsma", company: "Dashmote", city: "Amsterdam", address: "johan huizingalaan 763a", photo: File.open(Rails.root.join("db/fixtures/images", "logo_11.jpg")) },
  { email: "mandate@gmail.com", password: "12345678", first_name: "Mans" , last_name: "Timmerman", company: "Mandate", city: "Amsterdam", address: "bilderdijkkade 12", photo: File.open(Rails.root.join("db/fixtures/images", "logo_12.jpg")) },
  { email: "dailychef@gmail.com", password: "12345678", first_name: "Pieter" , last_name: "Janssen", company: "Daily Chef", city: "Amsterdam", address: "johan huizingalaan 763a", photo: File.open(Rails.root.join("db/fixtures/images", "logo_13.jpg")) },
  { email: "wetransfer@gmail.com", password: "12345678", first_name: "Nalden" , last_name: "Naldinga", company: "WeTransfer", city: "Amsterdam", address: "johan huizingalaan 763a", photo: File.open(Rails.root.join("db/fixtures/images", "logo_14.jpg")) },
]
